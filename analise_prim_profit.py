...
# Gerando a Resposta:
resposta = pd.read_csv("31sNPVProfit1Regret_resposta.csv", index_col=0, parse_dates=True)
...
incertezas = pd.read_csv("31sNPVProfit1Regret_incertezas.csv", index_col=0, parse_dates=True)
